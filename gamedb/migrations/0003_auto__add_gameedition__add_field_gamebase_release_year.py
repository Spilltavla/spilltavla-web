...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GameEdition'
        db.create_table('gamedb_gameedition', (
            ('gamebase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['gamedb.GameBase'], unique=True, primary_key=True)),
            ('edition_of', self.gf('django.db.models.fields.related.ForeignKey')(related_name='editions', to=orm['gamedb.Game'])),
        ))
        db.send_create_signal('gamedb', ['GameEdition'])

        # Adding field 'GameBase.release_year'
        db.add_column('gamedb_gamebase', 'release_year',
    ...
    def backwards(self, orm):
        # Deleting model 'GameEdition'
        db.delete_table('gamedb_gameedition')

        # Deleting field 'GameBase.release_year'
        db.delete_column('gamedb_gamebase', 'release_year')
